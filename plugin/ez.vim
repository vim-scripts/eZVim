...
" SearchSectionID is 22 to search only in 4.0 documentation
" TODO : configuration for future 4.x versions
let EzSearchDocBase="http://ez.no/doc/content/advancedsearch?SearchSectionID=22&PhraseSearchText="
let EzDocumentation="http://ez.no/doc/ez_publish/technical_manual/4_0"
...
function! EzTplEnvironment()
    ...
    """""""""" Fetch
    iabbrev ezfcn fetch( content, node, hash( 'node_id', ) )<ESC>3hi

    " content list
    iabbrev ezfcl fetch( content, list, hash( 'parent_node_id', __ ,<CR>'class_filter_type', include,<CR>'class_filter_array', array( __ ),<CR>'offset', $view_parameters.offset,<CR>'limit', __ ) )
    iabbrev ezfcls fetch( content, list, hash( 'parent_node_id', __ ,<CR>'class_filter_type', include,<CR>'class_filter_array', array( __ ),<CR>'sort_by', array( __ ),<CR>'offset', $view_parameters.offset,<CR>'limit', __ ) )
    iabbrev ezfcla fetch( content, list, hash( 'parent_node_id', __ ,<CR>'class_filter_type', include,<CR>'class_filter_array', array( __ ),<CR>'attribute_filter', array( __ ),<CR>'offset', $view_parameters.offset,<CR>'limit', __ ) )
    iabbrev ezfclas fetch( content, list, hash( 'parent_node_id', __ ,<CR>'class_filter_type', include,<CR>'class_filter_array', array( __ ),<CR>'sort_by', array( __ ),<CR>'attribute_filter', array( __ ),<CR>'offset', $view_parameters.offset,<CR>'limit', __ ) )
    ...
    iabbrev ezfcts fetch( content, tree, hash( 'parent_node_id', __ ,<CR>'class_filter_type', include,<CR>'class_filter_array', array( __ ),<CR>'sort_by', array( __ ),<CR>'offset', $view_parameters.offset,<CR>'limit', __ ) )
    iabbrev ezfcta fetch( content, tree, hash( 'parent_node_id', __ ,<CR>'class_filter_type', include,<CR>'class_filter_array', array( __ ),<CR>'attribute_filter', array( __ ),<CR>'offset', $view_parameters.offset,<CR>'limit', __ ) )
    iabbrev ezfctas fetch( content, tree, hash( 'parent_node_id', __ ,<CR>'class_filter_type', include,<CR>'class_filter_array', array( __ ),<CR>'sort_by', array( __ ),<CR>'attribute_filter', array( __ ),<CR>'offset', $view_parameters.offset,<CR>'limit', __ ) )
